...
def eval_model(args, questions, start, end, ans_file):
    ...
    for i, question in enumerate(questions):
        image_fn = osp.join(args.image_folder, question['image'])
        ...
        out_j_dict['answer'] = output_text
        out_j_dict_str = json.dumps(out_j_dict) + "\n"
        ans_fp.write(out_j_dict_str)
    ans_fp.close()
...
if __name__ == "__main__":
    ...
    with open(os.path.expanduser(args.question_file), "r") as f:
        questions = [json.loads(ln) for ln in f]
